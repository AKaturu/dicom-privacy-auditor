...
The real-source preflight now has 7 of 10 required checks ready. Public CBIIT validator source, Python 3.12 RSNA anonymizer tooling, IBM Aspera transfer tooling, public TCIA manifests/mappings, Orthanc, DICOMweb, DIMSE, and credential-presence checks are all represented in the evidence. The remaining required checks are not safely fabricatable.
