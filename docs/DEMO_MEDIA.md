...
The GIF is the inline GitHub README preview. It advances through benchmark generation, control comparison, and review-package creation; selecting it in the README opens the full MP4 walkthrough.
